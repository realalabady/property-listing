...
export const ROUTES = {
  ...
  DASHBOARD_EMPLOYEE_NEW: "/dashboard/employees/new",
  DASHBOARD_EMPLOYEE_DETAIL: (id: string) => `/dashboard/employees/${id}`,
  DASHBOARD_EMPLOYEE_PERMISSIONS: "/dashboard/employees/permissions",
